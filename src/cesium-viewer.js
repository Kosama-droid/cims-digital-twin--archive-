...
function initCesium() {
  ...
  //    GET PROVINCE 🗺️
    ...
    menuButton.onclick = function () {
      menu.style.display = toggleMenu ? "flex" : "none";
      menuButton.style.transform = toggleMenu ? "": "rotate(180deg)";
      const navBar = document.getElementById("nav-bar")
      navBar.style.backgroundColor = toggleMenu ? "": "#FFFFFF00";
      navBar.style.boxShadow = toggleMenu ? "": "none";
